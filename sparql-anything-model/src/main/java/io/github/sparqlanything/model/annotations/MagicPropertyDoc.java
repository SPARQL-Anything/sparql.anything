...
/**
 * Annotation for documenting SPARQL Anything magic properties.
...
public @interface MagicPropertyDoc {
	...
	/**
	 * Human-readable description of what the magic property does.
	 */
	String description();

	/**
	 * Example usage of the magic property in a SPARQL query snippet.
	 */
	String example();
	 ...
	 * If empty, derived from the property URI.
	 */
