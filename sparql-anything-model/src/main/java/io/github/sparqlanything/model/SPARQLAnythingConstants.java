...
public class SPARQLAnythingConstants {
	...
	public final static Symbol PROFILE = Symbol.create("profile");

	public enum PROFILE_EVENT {PROCESS_STARTS, BEFORE_INIT, AFTER_INIT, BEFORE_LOAD, AFTER_LOAD, PROCESS_ENDS, BEFORE_QUERY_EXECUTION, LOAD_MAIN_CLASS, BEFORE_TRIPLIFICATION, AFTER_TRIPLIFICATION, AFTER_QUERY_EXECUTION}
