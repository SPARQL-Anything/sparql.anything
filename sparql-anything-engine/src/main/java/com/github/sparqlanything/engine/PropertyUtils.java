...
//	static Properties getProperties(String url, OpService opService) throws UnboundVariableException {
//
...
//	}
	...
	private static void extractPropertiesFromOpGraph(Properties properties, OpBGP bgp) throws UnboundVariableException {
