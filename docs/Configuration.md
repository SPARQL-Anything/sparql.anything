...
| [query](#query)*                                                    | The `query` option takes the file path of a subquery as its value. It then executes the subquery and returns the results, depending on the query type. If the subquery is a SELECT, its bindings are returned (the subquery's variables are kept). Note that if the sub-query is a SELECT, any operations contained in the SERVICE clause of the outer query are ignored. If the sub-query is a CONSTRUCT  (or a [CONSTRUCT Quad](https://jena.apache.org/documentation/query/construct-quad.html)), the graph (or dataset) resulting from the sub-query is constructed and the operation contained in the SERVICE clause of the outer query is applied to it. Please note that if the 'query' option is set, the other options will be ignored. (See #177) | Any valid URL or (absolute or relative) path of the file system                                                                                                                       | *                                                                                                                                                                                                                                                                           |
| [from-archive](#from-archive)                                       | The filename of the resource to be triplified within an archive.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Any filename.                                                                                                                                                                         | No value                                                                                                                                                                                                                                                                    |
| [archive-format](#from-archive)                                     | The format of the archive whose URL is specified in `from-archive`. This option is needed only when the format of the archive (tar or zip) can not be guessed from the URL of the file (see [Issue #554](https://github.com/SPARQL-Anything/sparql.anything/issues/554)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Any supported archive format ("zip", "tar")                                                                                                                                           | No value                                                                                                                                                                                                                                                                    |
...
| [namespace](#namespace)                                             | The namespace prefix for the properties and classes that will be generated.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Any valid namespace prefix.                                                                                                                                                           | http://sparql.xyz/facade-x/data/                                                                                                                                                                                                                                            |
...
| [slice.size](#slice.size)                                           | When slice=true, sets the size of the batches to process. Supported by: CSV (row by row); JSON (when array slice by item, when json object requires `json.path`); XML (requires `xml.path`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Any valid positive number                                                                                                                                                             | 1                                                                                                                                                                                                                                                                           |
...
| [s3.endpoint](#s3)                                                  | When set to true, the location is interpreted as an endpoint for a the S3 storage service                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | true/false                                                                                                                                                                            | false                                                                                                                                                                                                                                                                       |
| [s3.bucket-name](#s3)                                               | The name of the s3 bucket to use as a source                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Any valid bucket name                                                                                                                                                                 | No value                                                                                                                                                                                                                                                                    |
| [s3.key](#s3)                                                       | The path of the file to retrieve from the s3 bucket                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Any valid file name                                                                                                                                                                   | No value                                                                                                                                                                                                                                                                    |
| [s3.access-key](#s3)                                                | The key for accessing the s3 bucket  (username)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Any valid access key                                                                                                                                                                  | No value                                                                                                                                                                                                                                                                    |
| [s3.secret-key](#s3)                                                | The secret key for accessing the s3 bucket  (password)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Any valid secret key                                                                                                                                                                  | No value                                                                                                                                                                                                                                                                    |
| [s3.region](#s3)                                                    | The region of the s3 bucket                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Any valid region name                                                                                                                                                                 | No value                                                                                                                                                                                                                                                                    |
...
The query option takes the file path of a subquery as its value. It then executes the subquery and returns the results, depending on the query type. If the subquery is a SELECT, its bindings are returned (the subquery's variables are kept). Note that if the sub-query is a SELECT, any operations contained in the SERVICE clause of the outer query are ignored. If the sub-query is a CONSTRUCT (or a CONSTRUCT Quad), the graph (or dataset) resulting from the sub-query is constructed and the operation contained in the SERVICE clause of the outer query is applied to it. Please note that if the 'query' option is set, the other options will be ignored.
...
##### UC1: Count the number of items in the JSON Array  `"[\"one\",\"two\",\"three\", \"four\"]"`
...
SELECT  (COUNT(?o) AS ?nOfItems)
WHERE
  { SERVICE <x-sparql-anything:query=select.rq> { }
  }
```
...
##### UC2: Count the number of items in the JSON Array  `"[\"one\",\"two\",\"three\", \"four\"]"`
...
WHERE
  { 
    SERVICE <x-sparql-anything:query=construct.rq> { 
        ?s fx:anySlot ?o
    }
  }
```

Sub query (construct.rq)
...
This option is only required when the archive format (tar or zip) cannot be determined from the file URL (see [Issue #554](https://github.com/SPARQL-Anything/sparql.anything/issues/554)).
...
When `slice` is `true`, this option sets how many slices (rows for CSV, items for JSON arrays/`json.path` matches, elements for XML `xml.path`) are triplified together and evaluated with a single query execution, instead of exactly one. Supported by: CSV, JSON, XML (same formats that support `slice`).

Increasing the value trades memory (bounded by roughly `slice.size` items' worth of triples at a time) for throughput, since the per-query-execution overhead is amortized over more items. As the value grows, behaviour approaches the `slice=false` (whole-source) case.

**Note:** with `slice.size` greater than 1, a query joining across multiple items — like UC2 above — can start producing matches *within* a batch, whereas with the default `slice.size=1` such joins never match (each execution only ever sees one item). This is intentional: larger batches move query semantics progressively closer to the unsliced case.

#### Valid Values

Any positive integer. Invalid values (missing, non-numeric, zero or negative) fall back to `1` with a warning.
...
```sparql
SERVICE <x-sparql-anything:location=allCountries.txt,slice=true,slice.size=100000,csv.headers=true,csv.delimiter=%09> { ... }
```

Triplifies and evaluates 100,000 rows per query execution instead of one, bounding memory to ~100k rows' worth of triples while avoiding per-row invocation overhead.
