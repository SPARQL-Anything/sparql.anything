...
//		Triplifier t = new TestTriplifier();
		try {
			...
			TriplifierRegister.getInstance().removeTriplifier("com.github.sparqlanything.engine.test.TestTriplifier");
	...
	public void testRelativePath() throws IOException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
		Class.forName("com.github.sparqlanything.engine.test.TestTriplifier2").getConstructor().newInstance();
		try {
...
//			TriplifierRegister.getInstance().registerTriplifier(t);
			TriplifierRegister.getInstance().registerTriplifier("com.github.sparqlanything.engine.test.TestTriplifier2", new String[]{"test2"}, new String[]{"test-mime2"});
			...
			TriplifierRegister.getInstance().removeTriplifier("com.github.sparqlanything.engine.test.TestTriplifier2");
