...
public final class FacadeX {
	...
	static {
		try {
			...
			Registry.registerTriplifier("com.github.sparqlanything.xml.XMLTriplifier",
					new String[] { "xml" }, new String[] { "application/xml" });
			Registry.registerTriplifier("com.github.sparqlanything.csv.CSVTriplifier",
					new String[] { "csv" }, new String[] { "text/csv" });
			Registry.registerTriplifier("com.github.sparqlanything.html.HTMLTriplifier",
					new String[] { "html" }, new String[] { "text/html" });
			Registry.registerTriplifier("com.github.sparqlanything.text.TextTriplifier",
					new String[] { "txt" }, new String[] { "text/plain" });
			Registry.registerTriplifier("com.github.sparqlanything.docs.DocxTriplifier",
					new String[] { "docx" }, new String[] { "application/vnd.openxmlformats-officedocument.wordprocessingml.document" });
			Registry.registerTriplifier("com.github.sparqlanything.zip.TarTriplifier",
					new String[] { "tar" }, new String[] { "application/x-tar" });
			Registry.registerTriplifier("com.github.sparqlanything.zip.ZipTriplifier",
			...
			Registry.registerTriplifier("com.github.sparqlanything.json.JSONTriplifier",
