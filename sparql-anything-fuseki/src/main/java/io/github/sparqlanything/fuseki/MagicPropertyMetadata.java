...
/**
 * Metadata for a SPARQL magic property extracted from annotations.
 */
public class MagicPropertyMetadata {
	...
	public MagicPropertyMetadata(String uri, Class<?> propertyClass) {
		this.uri = uri;
		this.propertyClass = propertyClass;
		
		MagicPropertyDoc doc = propertyClass.getAnnotation(MagicPropertyDoc.class);
		if (doc != null) {
			...
			this.description = "SPARQL Anything magic property";
			this.example = "";
			this.group = "MAGIC PROPERTIES";
