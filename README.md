...
| [root](Configuration.md#root)                       | The IRI of generated root resource.                                                                                                                                                                                                                                                                                                           | Any valid IRI.                                                                                                                                                                        | location + '#' (in the case of location argument  set) **or** 'http://sparql.xyz/facade-x/data/' + md5Hex(content) + '#' (in the case of content argument set) **or**  'http://sparql.xyz/facade-x/data/' + md5Hex(coomand) (in the case of command argument set)|
