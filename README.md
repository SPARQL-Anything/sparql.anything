...
![Java CI with Maven](https://github.com/sparql-anything/sparql.anything/actions/workflows/maven.yml/badge.svg?branch=v0.2-DEV)
...
|csv.null-string|It tells the CSV triplifier not produce triples where the specificed string would be in the object position of the triple.|any string|not set|
