...
public class RDFXMLWriterFactory implements TripleWriterFactory {
    ...
    public static final String MIME_TYPE = io.github.sparqlanything.html.org.apache.any23.writer.RDFXMLWriter.Internal.FORMAT.getMimeType();
    ...
    public TripleFormat getTripleFormat() {
        return io.github.sparqlanything.html.org.apache.any23.writer.RDFXMLWriter.Internal.FORMAT;
    }

    @Override
    public Settings getSupportedSettings() {
        return io.github.sparqlanything.html.org.apache.any23.writer.RDFXMLWriter.Internal.SUPPORTED_SETTINGS;
    }
