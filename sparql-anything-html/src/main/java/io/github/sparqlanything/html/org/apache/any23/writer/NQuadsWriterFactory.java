...
import io.github.sparqlanything.html.org.apache.any23.writer.NQuadsWriter;
...
public class NQuadsWriterFactory implements TripleWriterFactory {
    ...
    public static final String MIME_TYPE = io.github.sparqlanything.html.org.apache.any23.writer.NQuadsWriter.Internal.FORMAT.getMimeType();
    ...
    public TripleFormat getTripleFormat() {
        return io.github.sparqlanything.html.org.apache.any23.writer.NQuadsWriter.Internal.FORMAT;
    }

    @Override
    public Settings getSupportedSettings() {
        return io.github.sparqlanything.html.org.apache.any23.writer.NQuadsWriter.Internal.SUPPORTED_SETTINGS;
    }
