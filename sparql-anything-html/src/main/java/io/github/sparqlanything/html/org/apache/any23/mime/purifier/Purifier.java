...
public interface Purifier {
    ...
    /**
     * Performs the purification of the provided resettable {@link InputStream}.
     *
     * @param inputStream
     *            a resettable {@link InputStream} to be cleaned.
     *
     * @throws IOException
     *             if there is an error accessing the {@link InputStream}
     */
