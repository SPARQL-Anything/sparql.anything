...
import io.github.sparqlanything.html.org.apache.any23.writer.NTriplesWriter;
...
public class NTriplesWriterFactory implements TripleWriterFactory {
    ...
    public static final String MIME_TYPE = io.github.sparqlanything.html.org.apache.any23.writer.NTriplesWriter.Internal.FORMAT.getMimeType();
    ...
    public TripleFormat getTripleFormat() {
        return io.github.sparqlanything.html.org.apache.any23.writer.NTriplesWriter.Internal.FORMAT;
    }

    @Override
    public Settings getSupportedSettings() {
        return io.github.sparqlanything.html.org.apache.any23.writer.NTriplesWriter.Internal.SUPPORTED_SETTINGS;
    }
