...
import io.github.sparqlanything.html.org.apache.any23.writer.TriXWriter;
...
public class TriXWriterFactory implements TripleWriterFactory {
    ...
    public static final String MIME_TYPE = io.github.sparqlanything.html.org.apache.any23.writer.TriXWriter.Internal.FORMAT.getMimeType();
    ...
    public TripleFormat getTripleFormat() {
        return io.github.sparqlanything.html.org.apache.any23.writer.TriXWriter.Internal.FORMAT;
    }

    @Override
    public Settings getSupportedSettings() {
        return io.github.sparqlanything.html.org.apache.any23.writer.TriXWriter.Internal.SUPPORTED_SETTINGS;
    }
